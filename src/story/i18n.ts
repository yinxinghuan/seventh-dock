...
const dictionary = {
  zh: {
    ...
    itemImageIdle: '尚未绘制这件物品',
    itemImageQueued: '已进入绘制队列',
    itemImageGenerating: '正在绘制，可关闭后继续游戏',
    itemImageFailed: '绘制失败，可以重试',
  ...
  en: {
    ...
    itemImageIdle: 'This item has not been illustrated',
    itemImageQueued: 'Added to the illustration queue',
    itemImageGenerating: 'Drawing now — you may close this and keep playing',
    itemImageFailed: 'Illustration failed. You can retry.',
