...
const dictionary = {
  zh: {
    ...
    consistencyRecovery: '你开始行动，但眼前的情况没有顺利衔接。你仍在{name}，已经发生的事没有改变；可以先查看这里确实能做的事，或直接写下另一种行动。',
  ...
  en: {
    ...
    consistencyRecovery: 'The situation does not connect cleanly after you begin. You remain at {name}, and nothing established has changed. Review what is genuinely possible here or write a different action.',
